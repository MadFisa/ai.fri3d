...
def fit2insitu():
    ...
    def F(params):
        ...
        evo.poloidal_height = lambda t: p[9]+p[23]*(t-t0_cor)
        ...
        if res < res_prev:
            ...
            print('Expansion speed = ', u.Unit('m/s').to(u.Unit('km/s'), p[23]), file=fp)
            print(p, file=fp)
            fp.close()
    ...
    bounds = [
        ...
        # tuple(u.au.to(u.m, (0.01, 0.2)).tolist()),
        ...
        # tuple(u.deg.to(u.rad, (30.0, 40.0)).tolist()),
        # (1e13, 1e14),
        tuple(u.Unit('km/s').to(u.Unit('m/s'), (10.0, 200.0)).tolist()),
    ]
