...
def fit2insitu():
    ...
    bounds = [
        # SHARED
        (1e-3, 1e-2),
        tuple(u.Unit('km/s').to(u.Unit('m/s'), (2300.0, 2600.0)).tolist()),
        tuple(u.Unit('km/s').to(u.Unit('m/s'), (1400.0, 1700.0)).tolist()),
        tuple(u.Unit('km/s').to(u.Unit('m/s'), (1000.0, 1300.0)).tolist()),
        (1.6, 2.0),
        (0.7, 1.3),
        # MES
        (1e14, 1e15),
        ...
        tuple(u.au.to(u.m, (0.03, 0.11)).tolist()),
        ...
        tuple(u.au.to(u.m, (0.02, 0.08)).tolist()),
        tuple(u.deg.to(u.rad, (20.0, 40.0)).tolist()),
        tuple(u.deg.to(u.rad, (30.0, 60.0)).tolist()),
        (0.3, 0.5),
        tuple(u.deg.to(u.rad, (20.0, 40.0)).tolist()),
    ...
    #     polish=False
    # )
    x0 = [0.006650697062487106, 3032509.3064572043, 1606671.6667526662, 1143647.137468322, 1.6175108016396837, 0.9319797410149439, 390632426164572.75, 0.10505992188058672, 2.1977504596938284, 10896899117.09915, 0.336940619874607, 0.8151102477958424, 0.7585422469754912, 0.45994175742199694, 217004719256854.62, 0.2665157087766195, 2.0196450617985353, 5765344618.854327, 0.476177271655383, 0.8240552869431444, 0.49413236869036403, 0.49252365222147915, 35964842215542.06]
    res = basinhopping(
        F,
...
# MESSENGER:  0.0 3.21342138763e-06
# VEX:  0.0 0.136691484725 0.0791328135399
# STEREO-A:  0.0 0.0469624431217 0.0186921618984 0.15392082568
# AVERAGE:  0.0483781047096
# SHARED toroidal_height decay =  0.008577601895610472
# SHARED toroidal_height speed =  3221.5030373202057
# SHARED toroidal_height speed =  1641.3331948713676
# SHARED toroidal_height speed =  1212.3120178983088
# SHARED sigma =  1.6198079561798253
# SHARED twist =  0.9849689873339775
# MESSENGER flux =  359455639613153.5
# Venus Express latitude =  6.420312219317323
# Venus Express longitude =  123.78219711688884
# Venus Express poloidal_height =  0.06739060705144093
# Venus Express half_width =  19.282311202017443
# Venus Express tilt =  46.90844064188545
# Venus Express flattening =  0.7961235952532584
# Venus Express pancaking =  27.190818230403952
# Venus Express flux =  204995403155782.2
# STEREO-A latitude =  15.599663033167696
# STEREO-A longitude =  117.26989036560242
# STEREO-A poloidal_height =  0.03648423492250697
# STEREO-A half_width =  28.12062745812744
# STEREO-A tilt =  48.606113912725384
# STEREO-A flattening =  0.5225956144057934
# STEREO-A pancaking =  32.26661311218637
# STEREO-A flux =  37334740500917.8
# [0.008577601895610472, 3221503.0373202055, 1641333.1948713677, 1212312.0178983088, 1.6198079561798253, 0.9849689873339775, 359455639613153.5, 0.11205558723311158, 2.1604068950423425, 10081491320.075968, 0.33653981786938986, 0.8187067361772233, 0.7961235952532584, 0.4745693044318471, 204995403155782.2, 0.2722654821304217, 2.046745700332539, 5457963858.525622, 0.4907975368710477, 0.8483367243764817, 0.5225956144057934, 0.5631586372748266, 37334740500917.8]